...
public record SerializableDimensionData(Optional<ResourceKey<Level>> key, Optional<Integer> transitionHeight,
    ...
    public static Optional<SerializableDimensionData> of(Optional<ResourceKey<Level>> key, Optional<Integer> transitionHeight,
                                                         Optional<Boolean> renderUniverseInDimension, Optional<String> dimensionDayTimeControllerName,
                                                         Optional<Boolean> applyGravityCorrectionToEntities) {
        ...
        return Optional.of(new SerializableDimensionData(key, transitionHeight, renderUniverseInDimension, dimensionDayTimeControllerName, applyGravityCorrectionToEntities));
    }
}
